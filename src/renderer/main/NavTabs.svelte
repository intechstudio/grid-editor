...
c0,0.6-0.5,1.1-1.1,1.1h-8.1c-0.6,0-1.1-0.5-1.1-1.1v-8.1c0-0.6,0.5-1.1,1.1-1.1H21c0.6,0,1.1,0.5,1.1,1.1V20.4z"
    ...
    {#if $appSettings.persistant.showLoginRegister}
      ...
      >
        <svg
          class="w-full h-full p-0.5 text-white fill-current"
          id="Réteg_2_másolat"
          data-name="Réteg 2 másolat"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 21.12 26.57"
          ><path
            d="M17.9,5.26a2.73,2.73,0,0,0-.41,0A4.44,4.44,0,0,0,13.67,2.9,5.85,5.85,0,0,0,3,4.36a3.71,3.71,0,0,0,.82,7.34H9.26v.89a.9.9,0,0,0,1.8,0V11.7h6.86a3.22,3.22,0,0,0,0-6.44Zm0,4.64H11.06V7.59l.83.83a.9.9,0,0,0,.64.27.86.86,0,0,0,.63-.27.9.9,0,0,0,0-1.27L10.79,4.78a.9.9,0,0,0-1.27,0L7.15,7.15A.9.9,0,0,0,8.43,8.42l.83-.83V9.9H3.71a1.91,1.91,0,1,1,0-3.82.9.9,0,0,0,.9-.78,4,4,0,0,1,7.71-1.1.88.88,0,0,0,.93.52,2.65,2.65,0,0,1,2.83,1.89.9.9,0,0,0,.49.57.86.86,0,0,0,.75,0,1.44,1.44,0,0,1,.58-.13,1.43,1.43,0,0,1,1.42,1.42A1.4,1.4,0,0,1,17.92,9.9Z"
          /><path
            d="M13.17,13.89h-6a1.49,1.49,0,0,0-1.49,1.48v8a1.49,1.49,0,0,0,.65,1.23l2.43,1.67a1.49,1.49,0,0,0,.84.26,1.56,1.56,0,0,0,.69-.17,1.48,1.48,0,0,0,.79-1.31v-.47h2.11a1.48,1.48,0,0,0,1.48-1.48V15.37A1.48,1.48,0,0,0,13.17,13.89ZM9.26,24.48l-1.8-1.23V16.5l1.8,1.24Zm3.59-1.66H11.06V17.57a1.47,1.47,0,0,0-.64-1.22l-1-.66h3.39Z"
          /></svg
        >
