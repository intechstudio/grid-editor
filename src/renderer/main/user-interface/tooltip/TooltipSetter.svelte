<script>
  ...
  function mouseleaveCallback(e) {
    ...
    if (
      e.clientX > teb.x &&
      e.clientY > teb.y &&
      e.clientX < teb.x + teb.width &&
      e.clientY < teb.y + teb.height
    ) {
      //console.log("A")
    } else if (
      e.clientX > tpb.x &&
      e.clientY > tpb.y &&
      e.clientX < tpb.x + tpb.width &&
      e.clientY < tpb.y + tpb.height
    ) {
      //console.log("B")
    } else {
      //console.log("C")
  ...
  function mousemoveCallback(e) {
    ...
    if (
      e.clientX > teb.x - 5 &&
      e.clientY > teb.y - 5 &&
      e.clientX < teb.x + 5 + teb.width &&
      e.clientY < teb.y + 5 + teb.height
    ) {
      //console.log("X")
    } else if (
      e.clientX > tpb.x - 5 &&
      e.clientY > tpb.y - 5 &&
      e.clientX < tpb.x + 5 + tpb.width &&
      e.clientY < tpb.y + 5 + tpb.height
    ) {
      //console.log("Y")
    } else {
      //console.log("Z")
