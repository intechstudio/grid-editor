...
<presets
  ...
  <div
    ...
    <button
      ...
      class="{!checkIfOk(newPreset) ? 'cursor-not-allowed opacity-50' : 'cursor-pointer opacity-100  hover:bg-commit-saturate-10'}
          ...
          <li
            ...
            <div class="flex text-xs opacity-80 font-semibold">
              <div
                ...
                inline-block {newPreset.type == preset.type ? 'bg-green-500' : 'bg-gray-600'}
                ">
              ...
              <div
                ...
                v{preset.version.major}.{preset.version.minor}.{preset.version.patch}
              </div>
              <div
                class="m-1 flex justify-center text-center rounded-full px-2
                inline-block"
