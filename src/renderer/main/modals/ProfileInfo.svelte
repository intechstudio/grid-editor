...
<modal
  ...
  <div
    ...
    class=" z-50 w-3/5 h-fit max-h-[3/4] text-white relative flex flex-col
    ...
    <div class="p-6 flex flex-row gap-10 overflow-auto">
      <div class="w-3/5 flex flex-col gap-4">
        <div>
          <div class="text-green-400 font-semibold mb-4">Category</div>
      ...
      <div class="w-2/5 ">
        <div class="flex flex-col gap-4">
          ...
          <div class="flex flex-row items-center justify-between">
            <div>
              <div class="font-semibold mb-4">Author</div>
              <div>
                <img class="mb-2" src="/assets/imgs/user-image.png" alt="img" />
                <span>Jordan</span>
              </div>
            </div>
              ...
              <button
                ...
                {#if !liked}
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M37.0596 6.96976C36.4705 5.60586 35.6212 4.3699 34.5591
                      3.33109C33.4962 2.28917 32.243 1.46117 30.8677
                      0.892121C29.4415 0.299708 27.912 -0.00352347 26.3677
                      3.08886e-05C24.2012 3.08886e-05 22.0874 0.593293 20.2505
                      1.7139C19.811 1.98196 19.3936 2.2764 18.998 2.5972C18.6025
                      2.2764 18.1851 1.98196 17.7456 1.7139C15.9087 0.593293
                      13.7949 3.08886e-05 11.6284 3.08886e-05C10.0684
                      3.08886e-05 8.55664 0.298859 7.12842 0.892121C5.74853
                      1.46341 4.50488 2.28519 3.43701 3.33109C2.37352 4.36873
                      1.52398 5.60498 0.936523 6.96976C0.325684 8.38919
                      0.0136719 9.89651 0.0136719 11.4478C0.0136719 12.9112
                      0.3125 14.4361 0.905762 15.9873C1.40234 17.2837 2.11426
                      18.6284 3.02393 19.9864C4.46533 22.1353 6.44727 24.3765
                      8.9082 26.6485C12.9863 30.4146 17.0249 33.0161 17.1963
          ...
          <div>
            ...
            <div class="flex items-center gap-1">
              ...
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg">
                <g
                  clip-path="url(#clip0_23_130)"
                  filter="url(#filter0_d_23_130)">
                  <path
                    d="M4 54C4 26.3858 26.3858 4 54 4C81.6142 4 104 26.3858 104
                    54C104 81.6142 81.6142 104 54 104C26.3858 104 4 81.6142 4
                    54Z"
                    fill="black" />
                  <path
                    d="M19.9998 36.0002V69.6002H24.7998V36.0002H19.9998ZM29.5998
                    36.0002V69.6002H34.3998V36.0002H29.5998ZM39.1998
                    36.0002V69.6002H43.9998V36.0002H39.1998ZM48.7998
                    36.0002V69.6002H53.5998V36.0002H48.7998ZM58.3998
                    36.0002V40.8002H91.9998V36.0002H58.3998ZM58.3998
                    45.6002V50.4002H91.9998V45.6002H58.3998ZM58.3998
                    55.2002V60.0002H91.9998V55.2002H58.3998ZM58.3998
                    64.8002V69.6002H91.9998V64.8002H58.3998Z"
                    fill="white" />
                </g>
                <defs>
                  <filter
                    ...
                    <feBlend
                      ...
                      result="effect1_dropShadow_23_130" />
                    <feBlend
                      mode="normal"
                      in="SourceGraphic"
                      in2="effect1_dropShadow_23_130"
                      result="shape" />
                  </filter>
