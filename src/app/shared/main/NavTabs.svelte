...
<nav-tab style="background-color:rgb(25, 26, 32)" class=" flex px-1 flex-col items-center justify-between  h-full">
  <div class="flex flex-col">
    ...
    <div 
      ...
      <TooltipSetter mode={1} key={"sidebar_configuration_icon"}/>
    </div>
    ...
    <div 
      ...
      <TooltipSetter mode={1} key={"sidebar_preferences_icon"}/>
    </div>
  ...
  <div class="flex flex-col">
        ...
        <div 
          ...
          <TooltipSetter mode={1} key={"sidebar_profiles_icon"}/>
    ...
    <div 
      ...
      <TooltipSetter mode={1} key={"sidebar_debugger_icon"}/>
    ...
    <div class="left-0 -ml-1 absolute transition-all  {selectedLeftTab == 'MIDI Monitor' ? 'h-8' : 'h-2 group-hover:h-4'} w-2 rounded-full bg-white"></div>
    <TooltipSetter mode={1} key={"sidebar_midi_monitor_icon"}/>
