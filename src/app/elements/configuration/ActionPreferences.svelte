...
<preferences on:click={()=>{ preferencesMenu = ! preferencesMenu}} class="flex px-2 group justify-center items-center bg-transparent">
  <svg style="padding:0.125rem" class="h-6 w-6 group-hover:bg-purple-400 group-hover:cursor-pointer rounded-full" viewBox="0 0 8 32" fill="none" xmlns="http://www.w3.org/2000/svg">
