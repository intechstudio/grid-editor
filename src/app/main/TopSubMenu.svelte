  ...
  <div class="h-14 py-2 px-2 bg-secondary w-full relative rounded-tl-lg  flex items-center justify-between">
    ...
    <div class="px-4">
      ...
      <div class="flex items-center">
        ...
        <div class="mr-6 px-3 py-2 group relative flex items-center justify-center rounded-md {$engine_state == 'ENABLED' ? 'bg-blue-500' : 'bg-yellow-500'} ">
          <svg class="w-5 h-5 fill-current text-white" viewBox="0 0 465 385" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="group-hover:visible invisible absolute top-1 mt-8 right-0 bg-thirdery rounded-md px-4 py-2 w-64 z-10 shadow border border-gray-700">
            ...
            <p class="py-2">
              <span class="text-blue-500 pt-2">blue:</span> enabled <br> 
              <span class="text-yellow-500 pb-2">yellow:</span> disabled 
            </p>
            <p>
              This can be reactivated under preferences.
            </p>
          </div>
        </div>
