...
<main class="w-full relative" use:clickOutside on:click-outside={()=>{focus = false}}>
  ...
  {#if focus}
    <ul class:shadow={focus} style="max-height:250px; min-width:100px;" class="scrollbar block border-t overflow-y-auto border-important text-white cursor-pointer absolute w-auto bg-secondary z-50">
