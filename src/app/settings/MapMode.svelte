...
<div class="inline-block primary text-white rounded-lg p-4 mx-4 mt-4 z-20">
  ...
  <div class="m-2">Configuration is saved for bank <span class="text-important">{selectedBank}</span>.</div>
  <div class="m-2">Currently enabled number of banks: <span class="text-important">2</span>.</div>
  <button class="m-2 block bg-highlight w-32 font-medium text-white py-1 px-2 rounded-none border-none hover:bg-highlight-400 focus:outline-none">Switch Bank</button>
</div>